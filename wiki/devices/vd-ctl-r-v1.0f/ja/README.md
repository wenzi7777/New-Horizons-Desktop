...
VD-CTL/R v1.0.F 2026.4 は New Horizons ファミリーの主力ハードウェアリビジョンです。フルサイズのキーマトリックス、オンボードステータス LED、外部アドレサブル LED ストリップ、OLED ディスプレイ、物理アクションボタン、BQ25180 ベースの充電回路を搭載しています。
