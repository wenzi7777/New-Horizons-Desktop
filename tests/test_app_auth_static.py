...
class AppAuthStaticTest(unittest.TestCase):
    ...
    def test_launchpad_groups_devices_into_default_and_custom_folders(self):
        ...
        self.assertIn("folder-preview-devices", launchpad_source)
        ...
        self.assertIn("folder-device-item", launchpad_source)
        self.assertIn("FOLDER_PREVIEW_MAX_ITEMS", launchpad_source)
